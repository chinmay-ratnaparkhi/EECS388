...
;* Date/Time created: Tue Nov 11 07:32:42 2014                                *
;******************************************************************************
...
$C$DW$4	.dwtag  DW_TAG_subprogram, DW_AT_name("Timer_0_A_ISR_Handler")
...
$C$DW$6	.dwtag  DW_TAG_variable, DW_AT_name("g_pfnVectors")
	...
	.dwattr $C$DW$6, DW_AT_decl_line(0x59)
	.dwattr $C$DW$6, DW_AT_decl_column(0x0f)
;	C:\TI_CodeComposer\ccsv6\tools\compiler\arm_5.1.7\bin\armacpia.exe -@C:\\Users\\cratnapa\\AppData\\Local\\Temp\\7510812 
	.sect	".text"
	.clink
	.thumbfunc ResetISR
	.thumb
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../startup_ccs.c",line 170,column 5,is_stmt,isa 1
    .global _c_int00
    b.w     _c_int00
	.dwpsn	file "../startup_ccs.c",line 172,column 1,is_stmt,isa 1
$C$DW$8	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$7, DW_AT_TI_end_line(0xac)
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../startup_ccs.c",line 187,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L1||
;*
...
;* --------------------------------------------------------------------------*
||$C$L1||:    
        B         ||$C$L1||             ; [DPU_3_PIPE] |187| 
        ; BRANCH OCCURS {||$C$L1||}      ; [] |187| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$9, DW_AT_TI_end_file("../startup_ccs.c")
	.dwattr $C$DW$9, DW_AT_TI_end_line(0xbe)
...
$C$DW$10	.dwtag  DW_TAG_subprogram, DW_AT_name("FaultISR")
	...
	.dwpsn	file "../startup_ccs.c",line 201,column 1,is_stmt,address FaultISR,isa 1
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../startup_ccs.c",line 205,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L2||
;*
...
;* --------------------------------------------------------------------------*
||$C$L2||:    
        B         ||$C$L2||             ; [DPU_3_PIPE] |205| 
        ; BRANCH OCCURS {||$C$L2||}      ; [] |205| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$10, DW_AT_TI_end_file("../startup_ccs.c")
	.dwattr $C$DW$10, DW_AT_TI_end_line(0xd0)
...
$C$DW$11	.dwtag  DW_TAG_subprogram, DW_AT_name("IntDefaultHandler")
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../startup_ccs.c",line 223,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L3||
;*
...
;* --------------------------------------------------------------------------*
||$C$L3||:    
        B         ||$C$L3||             ; [DPU_3_PIPE] |223| 
        ; BRANCH OCCURS {||$C$L3||}      ; [] |223| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$11, DW_AT_TI_end_file("../startup_ccs.c")
	.dwattr $C$DW$11, DW_AT_TI_end_line(0xe2)
...
$C$DW$12	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$12, DW_AT_upper_bound(0x3b)
	.dwendtag $C$DW$T$22
