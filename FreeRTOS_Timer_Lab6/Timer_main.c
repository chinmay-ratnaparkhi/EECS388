...
//*****************************************************************************
//
//	External Task Task_TimeOfDay added
//
//*****************************************************************************
...
void Display(void *pvParameters){
    ...
    while(1){
	    ...
	    RIT128x96x4StringDraw(TimeString, 25, 16, 15);
	    //
	    // Re-executes after 500 ticks from the initial start time of the task
	    //
...
//*****************************************************************************
//
//	Task ADC 	-- Call in the main function has been commented out
//
//*****************************************************************************
void ADC(void *pvParameters){
	...
	while(1){
		...
		//
		xQueueSend(queue, (void *) &ulValue,(500));
		vTaskDelay(1000);
	}
}
//*****************************************************************************
//
//	Task DisplayADC	-- Call in the main function has been commented out
//
//*****************************************************************************
...
int main(void) {
	//
	// 	Create a queue with a length of 5 elements.
	//
	queue = xQueueCreate(5, sizeof(unsigned long));
	//
	//	Create a task to collect samples and send to the queue
	//
	//	xTaskCreate(ADC, (signed portCHAR*) "ADC", 512, NULL, 1, NULL);
	//
	//	Create a task to display the most recent ADC sample
	//
	//	xTaskCreate(DisplayADC, (signed portCHAR*) "DisplayADC", 512, NULL, 2, NULL);
	//
	...
	//
	//*****************************************************************************
	//	Task Task_TimeOfDay is Added to the main function
	//*****************************************************************************
	//
	xTaskCreate(Task_TimeOfDay, (signed portCHAR*) "Time Of Day", 512, NULL, 2, NULL);
	//
