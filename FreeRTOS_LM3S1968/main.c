...
#define freq1 			SYSTICK_FREQUENCY/(2*freq_val1)
#define freq2 			SYSTICK_FREQUENCY/(2*freq_val2)
...
void SpeakerBuzz(void *pvParameters){
	...
	//need to delay  1,000/(2*202) = 2.475 ms
...
int main(void) {
	...
	//
	//	Create a task to generate tone
	//
	xTaskCreate(SpeakerBuzz, (signed portCHAR*) "SpeakerBuzz", 512, NULL, 1, NULL);

	//
	//	Create a task to toggle tone frequency value
	//
