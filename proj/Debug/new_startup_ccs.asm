...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../new_startup_ccs.c")
...
$C$DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("SysTickIntHandler")
	...
	.dwattr $C$DW$1, DW_AT_decl_file("../new_startup_ccs.c")
...
$C$DW$2	.dwtag  DW_TAG_variable, DW_AT_name("__STACK_TOP")
	...
	.dwattr $C$DW$2, DW_AT_decl_file("../new_startup_ccs.c")
...
$C$DW$3	.dwtag  DW_TAG_variable, DW_AT_name("g_pfnVectors")
	...
	.dwattr $C$DW$3, DW_AT_decl_file("../new_startup_ccs.c")
	.dwattr $C$DW$3, DW_AT_decl_line(0x41)
	.dwattr $C$DW$3, DW_AT_decl_column(0x0f)
;	C:\TI_CodeComposer\ccsv6\tools\compiler\arm_5.1.7\bin\armopt.exe C:\\Users\\cratnapa\\AppData\\Local\\Temp\\255482 C:\\Users\\cratnapa\\AppData\\Local\\Temp\\255484 
	.sect	".text:ResetISR"
	.clink
	.thumbfunc ResetISR
	.thumb
...
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_return
        BX        LR                    ; [DPU_3_PIPE] 
        ; BRANCH OCCURS                  ; [] 
	.dwattr $C$DW$4, DW_AT_TI_end_file("../new_startup_ccs.c")
...
;* --------------------------------------------------------------------------*
||$C$L1||:    
	.dwpsn	file "../new_startup_ccs.c",line 163,column 11,is_stmt,isa 1
        B         ||$C$L1||             ; [DPU_3_PIPE] |163| 
        ; BRANCH OCCURS {||$C$L1||}      ; [] |163| 
	.dwattr $C$DW$6, DW_AT_TI_end_file("../new_startup_ccs.c")
...
;* --------------------------------------------------------------------------*
||$C$L2||:    
	.dwpsn	file "../new_startup_ccs.c",line 199,column 11,is_stmt,isa 1
        B         ||$C$L2||             ; [DPU_3_PIPE] |199| 
        ; BRANCH OCCURS {||$C$L2||}      ; [] |199| 
	.dwattr $C$DW$7, DW_AT_TI_end_file("../new_startup_ccs.c")
...
;* --------------------------------------------------------------------------*
||$C$L3||:    
	.dwpsn	file "../new_startup_ccs.c",line 181,column 11,is_stmt,isa 1
        B         ||$C$L3||             ; [DPU_3_PIPE] |181| 
        ; BRANCH OCCURS {||$C$L3||}      ; [] |181| 
	.dwattr $C$DW$8, DW_AT_TI_end_file("../new_startup_ccs.c")
...
$C$DW$T$26	.dwtag  DW_TAG_typedef, DW_AT_name("__builtin_va_list")
	...
	.dwattr $C$DW$T$26, DW_AT_decl_file("../new_startup_ccs.c")
